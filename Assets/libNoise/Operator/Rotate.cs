...
namespace LibNoise.Operator
{
    ...
    public class Rotate : ModuleBase
    {
        ...
        {
			var xc = System.Math.Cos(x * Mathf.Deg2Rad);
			var yc = System.Math.Cos(y * Mathf.Deg2Rad);
			var zc = System.Math.Cos(z * Mathf.Deg2Rad);
			var xs = System.Math.Sin(x * Mathf.Deg2Rad);
			var ys = System.Math.Sin(y * Mathf.Deg2Rad);
			var zs = System.Math.Sin(z * Mathf.Deg2Rad);
