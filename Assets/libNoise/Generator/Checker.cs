...
namespace LibNoise.Generator
{
    ...
    public class Checker : ModuleBase
    {
        ...
        {
            var ix = (int) (System.Math.Floor(Utils.MakeInt32Range(x)));
			var iy = (int) (System.Math.Floor(Utils.MakeInt32Range(y)));
			var iz = (int) (System.Math.Floor(Utils.MakeInt32Range(z)));
