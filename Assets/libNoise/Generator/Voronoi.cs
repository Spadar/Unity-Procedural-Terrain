    ...
    public class Voronoi : ModuleBase
    {
        ...
        public override double GetValue(double x, double y, double z)
        {
            ...
            if (_distance)
            {
                ...
                var yd = yc - y;
                var zd = zc - z;
				v = (System.Math.Sqrt(xd * xd + yd * yd + zd * zd)) * Utils.Sqrt3 - 1.0;
            }
            else
            {
                v = 0.0;
            }
			return v + (_displacement * Utils.ValueNoise3D((int) (System.Math.Floor(xc)), (int) (System.Math.Floor(yc)),
			(int) (System.Math.Floor(zc)), 0));
        }
